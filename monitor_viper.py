...
Lê logs/episode_log.csv (escrito por train.py), filtrando robot == "viper".
...
fig.suptitle("Monitor Viper — Robo de Futebol", fontsize=15, color=COR, fontweight="bold")
...
def desenhar(dados):
    ...
    status_box.set_text(f"Viper | {tot:,.0f} passos | {status(gr)}")
